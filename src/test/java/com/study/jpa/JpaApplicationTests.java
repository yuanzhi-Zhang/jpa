...
class JpaApplicationTests {
	...
	void contextLoads() throws ParseException {
		// String IdCard="362531199711054502";
		// 从控制端输入用户身份证
	...
	public void timeTest() {
		// ChronoUnit里面有年，月,日等计量，根据需求可以修改
		LocalDateTime ldt = LocalDateTime.now().plus(1, ChronoUnit.DAYS);
	...
	public String IDCardValidate(String IDStr) throws ParseException {
		...
		// 判断地区码是否有效
		Hashtable<String, String> areaCode = this.GetAreaCode();
